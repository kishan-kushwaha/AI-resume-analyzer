        ...
        <div className="container" style={{ maxWidth: 900 }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div ref={reportRef} style={{ background: 'var(--bg-primary)' }}>
              ...
              {/* Affiliate / Sponsored Ads Section */}
              <div className="glass-card" style={{ padding: 28, marginBottom: 24, border: '1px solid var(--purple-500)', position: 'relative', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: 0, right: 0, background: 'var(--purple-500)', color: '#fff', fontSize: 10, fontWeight: 800, padding: '4px 12px', borderBottomLeftRadius: 12 }}>SPONSORED</div>
                <div style={{ display: 'flex', gap: 8, marginBottom: 18, alignItems: 'center' }}>
                  <Zap size={16} color="var(--purple-400)" />
